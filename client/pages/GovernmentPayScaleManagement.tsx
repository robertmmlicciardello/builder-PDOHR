...
export const GovernmentPayScaleManagement: React.FC = () => {
  ...
  } = useGovernmentPayScale();
  const { toast } = useToast();
  const [selectedGrade, setSelectedGrade] = useState(1);
  const [isDialogOpen, setIsDialogOpen] = useState(false);
  const [editingScale, setEditingScale] = useState<GovernmentPayScale | null>(
    null,
  );
  ...
  const handleCreatePayScale = async () => {
    try {
      ...
      await createPayScale(
        newScale as Omit<GovernmentPayScale, "id" | "createdAt" | "updatedAt">,
      );
  ...
  const handleDeletePayScale = async (
    id: string,
    grade: number,
    step: number,
  ) => {
    if (
      !confirm(
        `Are you sure you want to delete pay scale for Grade ${grade}, Step ${step}?`,
      )
    ) {
      return;
    }
  ...
  const handleGenerateDefaults = async () => {
    if (
      !confirm(
        "This will generate default pay scales for all grades (1-20) and steps (1-10). Continue?",
      )
    ) {
      return;
    }
    ...
    <div className="space-y-6 p-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold">
            Government Pay Scale Management
          </h1>
          <h2 className="text-2xl font-bold text-red-600 mt-1">
            အစိုးရ လစာစာရင်း စီမံခန့်ခွဲမှု
          </h2>
          <p className="text-gray-600 mt-2">
            Manage government employee pay scales by grade and step
          </p>
        </div>
      ...
      {payScales.length === 0 && (
        <Alert>
          ...
          <AlertDescription>
            No government pay scales have been configured yet. Click "Generate
            Defaults" to create a basic structure.
          </AlertDescription>
        </Alert>
      )}
            ...
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center justify-between">
                  <span>
                    Grade {grade} Pay Scale / အဆင့် {grade} လစာစာရင်း
                  </span>
                ...
                {currentGradeScales.length > 0 ? (
                    ...
                    <TableBody>
                      {currentGradeScales.map((scale) => (
                        <TableRow key={`${scale.grade}-${scale.step}`}>
                          ...
                          <TableCell>
                            {scale.basicSalary.toLocaleString()} MMK
                          </TableCell>
                          <TableCell>
                            {scale.allowances.positionAllowance.toLocaleString()}{" "}
                            MMK
                          </TableCell>
                          <TableCell>
                            {scale.allowances.locationAllowance.toLocaleString()}{" "}
                            MMK
                          </TableCell>
                          <TableCell>
                            {scale.benefits.medicalAllowance.toLocaleString()}{" "}
                            MMK
                          </TableCell>
                          <TableCell>
                            {scale.benefits.transportAllowance.toLocaleString()}{" "}
                            MMK
                          </TableCell>
                          ...
                          <TableCell>
                            <Badge
                              variant={scale.isActive ? "default" : "secondary"}
                            >
                  ...
                  <div className="text-center py-8">
                    <p className="text-gray-500">
                      No pay scales configured for Grade {grade}
                    </p>
                    <Button
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
          ...
          <div className="grid gap-4 py-4">
            ...
            <div className="grid grid-cols-4 gap-4">
              <div>
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    setNewScale({ ...newScale, grade: parseInt(value) })
                  }
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    setNewScale({ ...newScale, step: parseInt(value) })
                  }
                  disabled={!!editingScale}
                >
                  <SelectTrigger>
              ...
              <div>
                ...
                <Input
                  type="date"
                  value={
                    newScale.effectiveDate
                      ? new Date(newScale.effectiveDate)
                          .toISOString()
                          .split("T")[0]
                      : ""
                  }
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setNewScale({
                          ...
                          allowances: {
                            ...newScale.allowances!,
                            locationAllowance: parseInt(e.target.value) || 0,
                          },
                        })
                      }
                    />
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setNewScale({
                          ...
                          allowances: {
                            ...newScale.allowances!,
                            riskAllowance: parseInt(e.target.value) || 0,
                          },
                        })
                      }
                    />
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setNewScale({
                          ...
                          benefits: {
                            ...newScale.benefits!,
                            foodAllowance: parseInt(e.target.value) || 0,
                          },
                        })
                      }
                    />
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setNewScale({
                          ...
                          benefits: {
                            ...newScale.benefits!,
                            familyAllowance: parseInt(e.target.value) || 0,
                          },
                        })
                      }
                    />
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setNewScale({
                          ...
                          benefits: {
                            ...newScale.benefits!,
                            housingAllowance: parseInt(e.target.value) || 0,
                          },
                        })
                      }
                    />
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setNewScale({ ...newScale, approvedBy: e.target.value })
                  }
            ...
            <div>
              ...
              <Textarea
                ...
                onChange={(e) =>
                  setNewScale({ ...newScale, remarks: e.target.value })
                }
              ...
              <Alert>
                ...
                <AlertDescription>
                  <div className="mt-2 space-y-1">
                    <div>
                      Basic Salary: {newScale.basicSalary?.toLocaleString()} MMK
                    </div>
                    <div>
                      Total Allowances:{" "}
                      {Object.values(newScale.allowances || {})
                    ...
                    <div>
                      Total Benefits:{" "}
                      {Object.values(newScale.benefits || {})
                        .reduce((sum, val) => sum + val, 0)
                        .toLocaleString()}{" "}
                      MMK
                    </div>
                    <div className="font-bold text-green-600">
                      ...
                      {(
                        ...
                        Object.values(newScale.allowances || {}).reduce(
                          (sum, val) => sum + val,
                          0,
                        ) +
                        Object.values(newScale.benefits || {}).reduce(
                          (sum, val) => sum + val,
                          0,
                        )
                      ).toLocaleString()}{" "}
          ...
          <DialogFooter>
            ...
            <Button
              onClick={
                editingScale ? handleUpdatePayScale : handleCreatePayScale
              }
            >
