...
export const ApprovalWorkflowManagement: React.FC<
  ApprovalWorkflowManagementProps
> = ({ userId = "current-user", userRole = "department_head" }) => {
  const {
    workflows,
    loading,
    fetchUserWorkflows,
  ...
  const getCurrentApprover = (
    ...
    return workflow.approvalLevels.find(
  ...
  const isCurrentUserApprover = (workflow: ApprovalWorkflow): boolean => {
    ...
    return (
      currentApprover?.approverId === userId ||
  ...
  const getFilteredWorkflows = () => {
    ...
    if (filterType !== "all") {
      filtered = filtered.filter(
        (workflow) => workflow.requestType === filterType,
      );
    }
  ...
  const openActionDialog = (
    workflow: ApprovalWorkflow,
    action: "approve" | "reject" | "delegate" | "view",
  ) => {
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <h2 className="text-2xl font-bold text-red-600 mt-1">
            အတည်ပြုမှု လုပ်ငန်းစဉ် စီမံခန့်ခွဲမှု
          </h2>
      ...
      <div className="grid grid-cols-5 gap-4">
        {statusFilters.map((filter, index) => (
          <Card
            key={filter.value}
            className={
              selectedTab === filter.value ? "ring-2 ring-blue-500" : ""
            }
          >
      ...
      <Tabs value={selectedTab} onValueChange={setSelectedTab}>
        <TabsList>
          ...
          <TabsTrigger value="pending">
            Pending (
            {statusFilters.find((f) => f.value === "pending")?.count || 0})
          </TabsTrigger>
          <TabsTrigger value="approved">
            Approved (
            {statusFilters.find((f) => f.value === "approved")?.count || 0})
          </TabsTrigger>
          <TabsTrigger value="rejected">
            Rejected (
            {statusFilters.find((f) => f.value === "rejected")?.count || 0})
          </TabsTrigger>
          <TabsTrigger value="escalated">
            Escalated (
            {statusFilters.find((f) => f.value === "escalated")?.count || 0})
          </TabsTrigger>
        </TabsList>
                        ...
                        <TableRow key={workflow.id}>
                          ...
                          <TableCell>
                            <div className="space-y-1">
                              ...
                              <span className="text-xs text-gray-500">
                                Level {workflow.currentLevel} of{" "}
                          ...
                          <TableCell>
                            {workflow.deadline && (
                              <div
                                className={`text-sm ${
                                  new Date(workflow.deadline) < new Date()
                            ...
                            {currentApprover && (
                              <div className="text-sm">
                                ...
                                <div className="text-gray-500">
                                  {currentApprover.approverRoleMyanmar}
                                </div>
                                {isCurrentApprover && (
                                  <Badge
                                    variant="outline"
                          ...
                          <TableCell>
                            <div className="flex gap-1">
                              <Button
                                ...
                                size="sm"
                                onClick={() =>
                                  openActionDialog(workflow, "view")
                                }
                              >
                                ...
                                workflow.status === "pending" && (
                                  <>
                                    <Button
                                      ...
                                      size="sm"
                                      onClick={() =>
                                        openActionDialog(workflow, "approve")
                                      }
                                    ...
                                    <Button
                                      ...
                                      size="sm"
                                      onClick={() =>
                                        openActionDialog(workflow, "reject")
                                      }
                                    ...
                                    {currentApprover?.canDelegate && (
                                      <Button
                                        ...
                                        size="sm"
                                        onClick={() =>
                                          openActionDialog(workflow, "delegate")
                                        }
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="text-lg">
                    Approval Flow / အတည်ပြုမှု လုပ်ငန်းစဉ်
                  </CardTitle>
                </CardHeader>
                <CardContent>
                      ...
                      <div key={level.level} className="relative">
                        ...
                        <div
                          className={`flex items-start gap-4 p-4 border rounded-lg ${
                            level.level === selectedWorkflow.currentLevel
                      ...
                      <>
                        <div className="grid grid-cols-2 gap-4">
                          ...
                          <div>
                            ...
                            <Input
                              ...
                              onChange={(e) =>
                                setDelegateToName(e.target.value)
                              }
                        ...
                        <div>
                          ...
                          <Textarea
                            ...
                            onChange={(e) =>
                              setDelegationReason(e.target.value)
                            }
                  ...
                  <div className="space-y-3">
                    {selectedWorkflow.workflowHistory
                      ...
                      .map((history) => (
                        <div
                          key={history.id}
                          className="flex items-start gap-3 p-3 border-l-2 border-gray-200"
                        >
                          ...
                          <div className="flex-1">
                            <p className="font-medium text-sm">
                              ...
                              by {history.performedByName}
                            </p>
                            <p className="text-xs text-gray-500">
                              {history.actionMyanmar}
                            </p>
                            {history.comments && (
                              <p className="text-sm text-gray-600 mt-1">
                                "{history.comments}"
          ...
          <DialogFooter>
            ...
            {actionType === "delegate" && (
              <Button
                ...
                disabled={
                  !delegateTo || !delegateToName || !delegationReason.trim()
                }
              >
                Delegate Request
              </Button>
