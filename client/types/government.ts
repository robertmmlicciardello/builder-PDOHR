...
export interface ServiceRecord {
  id: string;
  personnelId: string;
  recordType: 'appointment' | 'promotion' | 'transfer' | 'disciplinary' | 'training' | 'award' | 'leave' | 'resignation';
  title: string;
  titleMyanmar: string;
  description: string;
...
export interface ApprovalWorkflow {
  id: string;
  requestId: string;
  requestType: 'leave' | 'promotion' | 'transfer' | 'disciplinary' | 'training' | 'expense' | 'recruitment';
  requestTitle: string;
...
export interface ApprovalLevel {
  ...
  canSkip: boolean;
  timeoutHours: number;
  status: 'pending' | 'approved' | 'rejected' | 'skipped' | 'delegated' | 'timeout';
  actionDate?: Date;
  comments?: string;
...
export interface WorkflowHistory {
  id: string;
  action: 'submitted' | 'approved' | 'rejected' | 'delegated' | 'escalated' | 'withdrawn' | 'timeout';
...
export const MYANMAR_MINISTRIES = [
  { code: 'MOI', name: 'Ministry of Information', nameMyanmar: 'ပြန်ကြားရေးဝန်ကြီးဌာန' },
  { code: 'MOE', name: 'Ministry of Education', nameMyanmar: 'ပညာရေးဝန်ကြီးဌာန' },
  { code: 'MOH', name: 'Ministry of Health and Sports', nameMyanmar: 'ကျန်းမာရေးနှင့်အားကစားဝန်ကြီးဌာန' },
  { code: 'MOHA', name: 'Ministry of Home Affairs', nameMyanmar: 'ပြည်ထဲရေးဝန်ကြီးဌာန' },
  { code: 'MOD', name: 'Ministry of Defence', nameMyanmar: 'ကာကွယ်ရေးဝန်ကြီးဌာန' },
  { code: 'MOALI', name: 'Ministry of Agriculture, Livestock and Irrigation', nameMyanmar: 'လယ်ယာမွေးမြူရေးနှင့်ရေလုပ်ငန်းဝန်ကြီးဌာန' },
  { code: 'MOPF', name: 'Ministry of Planning and Finance', nameMyanmar: 'ကိန်းဂဏန်းနှင့်ဘာရေးဝန်ကြီးဌာန' },
  { code: 'MOTC', name: 'Ministry of Transport and Communications', nameMyanmar: 'ပို့ဆောင်ရေးနှင့်ဆက်သွယ်ရေးဝန်ကြီးဌာန' },
  { code: 'MONREC', name: 'Ministry of Natural Resources and Environmental Conservation', nameMyanmar: 'သဘာဝသယံဇာတနှင့်သဘာဝပတ်ဝန်းကျင်ထိန်းသိမ်းရေးဝန်ကြီးဌာန' },
  { code: 'MOEE', name: 'Ministry of Electricity and Energy', nameMyanmar: 'လျှပ်စစ်နှင့်စွမ်းအင်ဝန်ကြီးဌာန' }
] as const;
